...
<body>
   <?php
        ...
        $consulta="SELECT *,c.NombreCateg,a.NombreAutor,g.NombreGenero from producto p JOIN categoria c on c.IdCateg=p.IdProducto JOIN autor a on a.IdAutor= p.IdAutorFK JOIN genero g on g.IdGenero=p.IdGeneroFK;";
