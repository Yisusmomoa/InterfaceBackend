        ...
        <table class="table table-light table-hover ">
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($resultado)){
                   $SubTotal+=$row["Precio"]*$row['UnidadesVenta'] ;
            ?>
                <tr>
                <th scope="row"><?php echo $i ?></th>
                <td><?php echo $row["NombreProducto"]; ?></td>
                <td><?php echo $row["UnidadesVenta"]; ?></td> 
                <td><?php echo $row["Precio"]; ?></td>
                <td><?php echo $row["Precio"]*$row['UnidadesVenta'] ?></td>
                </tr>
            <?php
             $i++;
                }
            ...
            <tr>
            <td id="SubTotal">
                    <h3>IVA: <?php echo  $SubTotal*0.16 ?> $ </h3>
            </td>
            </tr> 
            
            <tr>
            <td id="SubTotal">
                    <h3>Supertotal: <?php echo $SubTotal+=($SubTotal*0.16); ?> $ </h3>
            </td>
            </tr>
            </tbody>
        </table>
