...
<br><br><br>
    ...
    <nav class="navbar">
        ...
        <form class="d-flex">
          <input type="text" name="" id="idusfavs" hidden value="<?php echo $_SESSION['s_usuario'][0]['IdUsuario']?>">
            <input class="form-control me-2" id="searchfavs" type="search" placeholder="Search" aria-label="Search">
...
<div class="containercardsprods" id="resultBusquedaFavs">
...
?>
      ...
      <div class="box">
          <a href=""> <img src="\php\DiscOrder3\ImagenesServidor\<?php echo $row['ImgProdMinRuta'];?>"> </a>
          <div class="InfoProd">
