...
<div class="containerinfopago">
   ...
   <div class="cardinfopago">
        ...
        <input type="text" placeholder="Nombre titular" name="" id="">
        <br><br>
      
        <input type="text" placeholder="Numero tarjeta" name="" id="">
        <br><br>
      
        <input type="text" placeholder="Fecha expiración" name="" id="">
        <br><br>
      
        <input type="text" placeholder="CVC" name="" id="">
        <br><br>
        <div class="col-lg-4 offset-lg-4">
          <div class="checkout">
              <button class="proceed-btn" onclick="EfectuarCompra(<?php echo $_GET['IdUs'] ?>, <?php echo $_GET['TotalVenta']; ?>);">CONFIRMAR</button>
          </div>
        </div>
   </div>
</div>
